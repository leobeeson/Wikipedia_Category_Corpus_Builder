...
get_pages <- function(category){
  pages <- ""
  page_fetching <- tryCatch(
    {
    pages_out <- pages_in_category(language = "en", project = "wikipedia", categories = category, type = "page", limit = 500)
